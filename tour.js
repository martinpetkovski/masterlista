...
(function() {
    ...
    var STEPS = [
        ...
        { page: '/', title: 'Филтри', text: 'Топ листата не е само една — има повеќе варијанти:<br><br>• <strong>Оригинална</strong> — апсолутно сите песни достапни на Spotify<br>• <strong>Алтернативна</strong> — сите песни кои не се поп<br>• <strong>Сите времиња</strong> — кумулативна листа на сите артисти според бројот на следачи на Spotify<br><br>Филтрите можеш и да ги комбинираш меѓу себе за поспецифичен резултат.', el: '.chart-filter-bar', pos: 'bottom' },
